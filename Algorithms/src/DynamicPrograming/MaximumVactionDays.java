 ...
 *
 */
public class MaximumVactionDays {
        ...
        for (int week = 0; week < k; week++) {
            ...
            for (int des = 0; des < n; des++) {
                for (int src = 0; src < n; src++) {
                	System.out.println("flights[" + src + "][" + des + "] : " + flights[src][des]);
                    if (flights[src][des] == 1 || src == des) {
                    	System.out.println("temp[" + des + "] : " + temp[des]);
                    	temp[des] = Math.max(temp[des], dp[src] + days[des][week]);
                    }
                }
